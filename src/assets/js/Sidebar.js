...
Sidebar.prototype.init = function()
{
	...
	this.addStencilPalette('flowchart', 'Flowchart', dir + '/flowchart.xml',
		';whiteSpace=wrap;html=1;fillColor=#ffffff;strokeColor=#000000;strokeWidth=2');
	this.addImagePalette('Antennes', mxResources.get('Antennes'), dir + '/Antennes/', '_128x128.png',
 ...
 * Adds the general palette to the sidebar.
 */
Sidebar.prototype.addAntennesPalette = function(expand)
{
	var sb = this;
	var lineTags = 'line lines connector connectors connection connections arrow arrows '
	...
	this.addPaletteFunctions('Antennes', mxResources.get('Antennes'), (expand != null) ? expand : true, fns);
};
/**
